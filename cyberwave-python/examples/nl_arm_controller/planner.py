...
def plan_from_utterance(
    ...
    *,
    ...
    """Call Gemini with `utterance` and return a `PlanResult`.

    Picks up `GOOGLE_API_KEY` from the environment.
    """
    ...
    # Give the planner enough output headroom for a full JSON motion plan.
